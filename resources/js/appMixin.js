...
/*
return;
alert( 'resources/js/appMixin.js::' )
...
export default {
    ...
    methods: {
        ...
        //     console.log('showFlashMessage page::')
        //     console.log(page)
        //
        ...
        //
        //     if (page.props.jetstream && page.props.jetstream.flash && page.props.jetstream.flash.length > 0) {
        //         Toast.fire({
        //             icon: 'success',
        //             title: page.props.jetstream.flash
        //         })
        //     }
        // },
        formatLatestCurrencyHistoryValue(currency, rateDecimalNumbers) {
...
appMixin.js?ec54:34 {0: 'message', 1: 'Currency # 36 not found 1 !' *!/
        ...
        pluralize3(items_length, no_items_text, single_item_text, multi_items_text) {
        ...
        async getBlockPage(page_slug) {
            // console.log('getBlockPage page_slug::')
            // console.log(page_slug)
            const response = await axios.get('/get_block_page/' + page_slug)
