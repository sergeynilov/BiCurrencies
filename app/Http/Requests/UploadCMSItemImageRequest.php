...
class UploadCMSItemImageRequest extends FormRequest
{
    ...
    {
//        $request = request();
//        \Log::info(varDump($request, ' -1 UploadCMSItemImageRequest $request::'));
...
//        \Log::info(  varDump($max_size, ' -1 $max_size::') );
        ...
        $cms_item_image_dimension_limits = config('app.cms_item_image_dimension_limits');
        $max_width              = $cms_item_image_dimension_limits['max_width'] ?? 400;
...
//        \Log::info(  varDump($rules, ' -1 UploadCMSItemImageRequest $rules::') );
        return $rules;
    }
